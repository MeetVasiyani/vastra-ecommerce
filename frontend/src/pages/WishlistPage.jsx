        ...
        >
          <div className="container py-5">
            ...
            >
              ...
              >
                <Heart size={48} style={{ color: "#dc3545", opacity: 0.7 }} />
              </div>
              <h3
                className="mb-3"
            ...
            >
              <div
                ...
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    "linear-gradient(135deg, var(--vastra-beige), var(--vastra-ivory))",
              ...
              >
                Start adding your favorite pieces to your wishlist. Explore our
    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--vastra-beige) 0%, var(--vastra-ivory) 100%)",
          ...
          <div className="container">
            ...
            >
              ...
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <span style={{ color: "var(--vastra-maroon)", opacity: 0.5 }}>
                  /
                </span>
                <span
                  style={{ color: "var(--vastra-maroon)", fontSize: "0.9rem" }}
                >
                  My Wishlist
                </span>
              </div>
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          ...
                          "https://via.placeholder.com/400x500?text=Vastra"
                        }
                    ...
                    <div className="p-3">
                      ...
                      <motion.button
                        ...
                        whileHover={{
                          scale: addingToCartId === item.id ? 1 : 1.02,
                        }}
                        whileTap={{
                          scale: addingToCartId === item.id ? 1 : 0.98,
                        }}
                      >
